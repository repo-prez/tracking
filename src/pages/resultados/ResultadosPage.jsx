...
function ResultadosPage() {
  ...
  const targets = document.querySelectorAll(".animate_scrolling");
  ...
  return (
    <>
      ...
      <div className='w-full flex '>
        ...
        <div className="w-1/2 flex flex-col items-start justify-center lg:pl-10 xl:pl-20 animate_scrolling">
      ...
      <div className='relative w-full flex pt-6 xl:w-screen animate_scrolling'>
